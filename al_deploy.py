...
def main():
    ...
    if uploaded_file is not None:
        st.markdown("<style>.stImageContainer img { display: block;  }</style>", unsafe_allow_html=True)
        st.image(uploaded_file, caption='Uploaded Image.', use_column_width=False, width=176)
